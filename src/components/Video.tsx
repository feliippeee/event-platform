...
export function Video(props: VideoProps) {
    ...
    return (
        <div className="flex-1">
            ...
            <div className="px-6 pt-6 md:p-8 max-w-[1100px] mx-auto">
                ...
                <div className="gap-8 my-16 md:my-20 grid md:grid-cols-2">
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-0 md:gap-6 hover:bg-gray-600 transition-colors"> 
                        <div className="bg-green-700 h-full p-6 flex items-center">
                            <FileArrowDown size={40} />
                        </div>
                        <div className="pl-4 md:pl-0 py-6 leading-relaxed">
                        ...
                        <div className="h-full pr-6 flex items-center">
                            <CaretRight size={24} />
                        </div>
                    </a>
                    <a href="" className="bg-gray-700 rounded overflow-hidden flex items-stretch gap-0 md:gap-6 hover:bg-gray-600 transition-colors"> 
